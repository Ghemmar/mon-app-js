        ...
        stage('Deploy') {
            steps {
                script {
                    ...
                    bat 'kubectl --kubeconfig="C:\\Users\\insy\\.kube\\config" apply -f deployment.yaml --validate=false'
                    bat 'kubectl --kubeconfig="C:\\Users\\insy\\.kube\\config" apply -f service.yaml --validate=false'
                }
            }
        }
    }
